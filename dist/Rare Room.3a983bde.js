...
})({"b5V6I":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d8ba90343a983bde";
"use strict";
...
},{}],"9FFWR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "$settingsArrowDown", ()=>$settingsArrowDown);
parcelHelpers.export(exports, "settings", ()=>settings);
parcelHelpers.export(exports, "main", ()=>main);
parcelHelpers.export(exports, "closeSettings", ()=>closeSettings);
parcelHelpers.export(exports, "switchPageDefaults", ()=>switchPageDefaults);
...
const [[$settingsContent]] = [
    '.content'
].map((descriptor)=>$settings.querySelectorAll(descriptor));
const [$$settingsSections] = [
    ':scope > div'
].map((descriptor)=>$settingsContent.querySelectorAll(descriptor));
// Global vars
...
function main() {
    ...
    (0, _audioJs.setAudioStatus)(settings.sound);
    $$settingsSections.forEach(($settingsSection)=>{
        const [$$buttons] = [
            'button'
        ].map((descriptor)=>$settingsSection.querySelectorAll(descriptor));
    ...
    if ((0, _indexJs.$main).classList.contains('first-inverted')) $settingsArrowDown.classList.add('up-away');
    updateContentPosition();
}
function updateContentPosition() {
    const closedTopOffset = 2;
    $settings.style.setProperty('--closed-top', `-${$settings.offsetHeight + closedTopOffset}px`);
    ...
    $settingsArrowDown.style.setProperty('--margin-top', `${$settings.offsetHeight + settingArrowOffsetTop}px`);
 ...
 */ function onWindowLoadedOrResized(event) {
    ...
    if (aspectRatio > 1.0 && newAspectRatio <= 1.0 || aspectRatio <= 1.0 && newAspectRatio > 1.0) closeSettings();
...
function switchPageDefaults() {
    ...
    $settingsArrowDown.classList.add('active');
    if (!(0, _indexJs.$main).classList.contains('first-inverted')) $settingsArrowDown.classList.remove('up-away');
}
// Event Listeners
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./index.js":"8sYvG","./audio.js":"aReRV"}]},["b5V6I","9FFWR"], "9FFWR", "parcelRequired352", {})

//# sourceMappingURL=Rare Room.3a983bde.js.map
